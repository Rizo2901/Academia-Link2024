...
import 'perfil_estudiante_model.dart';
export 'perfil_estudiante_model.dart';

class PerfilEstudianteWidget extends StatefulWidget {
  const PerfilEstudianteWidget({
    super.key,
    required this.perfilEstudiantes,
  });

  final EstudiantesRecord? perfilEstudiantes;

  @override
  State<PerfilEstudianteWidget> createState() => _PerfilEstudianteWidgetState();
}

class _PerfilEstudianteWidgetState extends State<PerfilEstudianteWidget> {
  late PerfilEstudianteModel _model;
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 0.0, 10.0),
                                    child: TextFormField(
                                      controller: _model.txtGrupoController,
                                      focusNode: _model.txtGrupoFocusNode,
                                      autofocus: true,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelStyle: FlutterFlowTheme.of(context)
                                  ...
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 0.0, 10.0),
                                    child: TextFormField(
                                      controller: _model.txtGradoController,
                                      focusNode: _model.txtGradoFocusNode,
                                      autofocus: true,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelStyle: FlutterFlowTheme.of(context)
