        ...
        body: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                if (valueOrDefault(currentUserDocument?.rol, '') == 'Profesor')
                  Expanded(
                    child: Align(
                      alignment: const AlignmentDirectional(1.0, 0.0),
                      child: Padding(
              ...
              children: [
                Flexible(
                  child: Padding(
                    ...
                    child: Container(
                      width: MediaQuery.sizeOf(context).width * 1.0,
                      height: MediaQuery.sizeOf(context).height * 0.734,
                      decoration: BoxDecoration(
                        ...
                        builder: (context, snapshot) {
                          ...
                          return SingleChildScrollView(
                            child: Column(
                              ...
                              children:
                                  List.generate(columnAnunciosRecordList.length,
                                      (columnIndex) {
                                ...
                                return Container(
                                  width: MediaQuery.sizeOf(context).width * 1.0,
                                  height:
                                      MediaQuery.sizeOf(context).height * 0.288,
                                                            ...
                                                            var confirmDialogResponse =
                                                                await showDialog<
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return AlertDialog(
                                                                          content:
                                                                              const Text('Está seguro que desea eliminar este anuncio?'),
                                                                          actions: [
                                                                            TextButton(
