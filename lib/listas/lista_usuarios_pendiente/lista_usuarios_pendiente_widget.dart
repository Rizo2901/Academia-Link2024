...
import 'lista_usuarios_pendiente_model.dart';
export 'lista_usuarios_pendiente_model.dart';

class ListaUsuariosPendienteWidget extends StatefulWidget {
  const ListaUsuariosPendienteWidget({super.key});

  @override
  State<ListaUsuariosPendienteWidget> createState() =>
      _ListaUsuariosPendienteWidgetState();
}

class _ListaUsuariosPendienteWidgetState
    extends State<ListaUsuariosPendienteWidget> {
  late ListaUsuariosPendienteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListaUsuariosPendienteModel());
