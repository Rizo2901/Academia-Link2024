...
import 'lista_profesores_pendiente_model.dart';
export 'lista_profesores_pendiente_model.dart';

class ListaProfesoresPendienteWidget extends StatefulWidget {
  const ListaProfesoresPendienteWidget({super.key});

  @override
  State<ListaProfesoresPendienteWidget> createState() =>
      _ListaProfesoresPendienteWidgetState();
}

class _ListaProfesoresPendienteWidgetState
    extends State<ListaProfesoresPendienteWidget> {
  late ListaProfesoresPendienteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListaProfesoresPendienteModel());
