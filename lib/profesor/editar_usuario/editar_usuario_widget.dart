...
class _EditarUsuarioWidgetState extends State<EditarUsuarioWidget> {
  ...
  void initState() {
    ...
    _model.txtNuevaCedulaController ??= TextEditingController();
    _model.txtNuevaCedulaFocusNode ??= FocusNode();

    _model.txtNuevoNombreController ??= TextEditingController();
    _model.txtNuevoNombreFocusNode ??= FocusNode();

    _model.txtNuevoApellido1Controller ??= TextEditingController();
    _model.txtNuevoApellido1FocusNode ??= FocusNode();

    _model.txtNuevoApellido2Controller ??= TextEditingController();
    _model.txtNuevoApellido2FocusNode ??= FocusNode();

    _model.txtNuevoCorreoController ??= TextEditingController();
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.txtNuevaCedulaController,
                                          focusNode:
                                              _model.txtNuevaCedulaFocusNode,
                                          autofocus: true,
                                          obscureText: false,
                                          ...
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium,
                                          validator: _model
                                              .txtNuevaCedulaControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.txtNuevoNombreController,
                                          focusNode:
                                              _model.txtNuevoNombreFocusNode,
                                          autofocus: true,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            labelText:
                                          ...
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium,
                                          validator: _model
                                              .txtNuevoNombreControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .txtNuevoApellido1Controller,
                                          focusNode:
                                              _model.txtNuevoApellido1FocusNode,
                                          autofocus: true,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            labelText:
                                      ...
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .txtNuevoApellido2Controller,
                                          focusNode:
                                              _model.txtNuevoApellido2FocusNode,
                                          autofocus: true,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            labelText:
                                      ...
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.txtNuevoCorreoController,
                                          focusNode:
                                              _model.txtNuevoCorreoFocusNode,
                                          autofocus: true,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            labelText:
                                          ...
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium,
                                          validator: _model
                                              .txtNuevoCorreoControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                      Padding(
