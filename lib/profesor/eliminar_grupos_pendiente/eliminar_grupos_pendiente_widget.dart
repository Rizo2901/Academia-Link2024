...
import 'eliminar_grupos_pendiente_model.dart';
export 'eliminar_grupos_pendiente_model.dart';

class EliminarGruposPendienteWidget extends StatefulWidget {
  const EliminarGruposPendienteWidget({super.key});

  @override
  State<EliminarGruposPendienteWidget> createState() =>
      _EliminarGruposPendienteWidgetState();
}

class _EliminarGruposPendienteWidgetState
    extends State<EliminarGruposPendienteWidget> {
  late EliminarGruposPendienteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EliminarGruposPendienteModel());
