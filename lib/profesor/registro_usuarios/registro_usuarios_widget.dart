...
class _RegistroUsuariosWidgetState extends State<RegistroUsuariosWidget> {
  ...
  void initState() {
    ...
    _model.txtFCedulaController ??= TextEditingController();
    _model.txtFCedulaFocusNode ??= FocusNode();

    _model.txtFNombreController ??= TextEditingController();
    _model.txtFNombreFocusNode ??= FocusNode();

    _model.txtFPApellidoController ??= TextEditingController();
    _model.txtFPApellidoFocusNode ??= FocusNode();

    _model.txtFSApellidoController ??= TextEditingController();
    _model.txtFSApellidoFocusNode ??= FocusNode();
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              focusNode: _model.txtFCedulaFocusNode,
                              autofocus: true,
                              obscureText: false,
                              ...
                              validator: _model.txtFCedulaControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              style: FlutterFlowTheme.of(context).bodyMedium,
                              validator: _model.txtFNombreControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              focusNode: _model.txtFPApellidoFocusNode,
                              autofocus: true,
                              obscureText: false,
                              decoration: InputDecoration(
                              ...
                              style: FlutterFlowTheme.of(context).bodyMedium,
                              validator: _model.txtFPApellidoControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              focusNode: _model.txtFSApellidoFocusNode,
                              autofocus: true,
                              obscureText: false,
                              decoration: InputDecoration(
                              ...
                              style: FlutterFlowTheme.of(context).bodyMedium,
                              validator: _model.txtFSApellidoControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                          Padding(
