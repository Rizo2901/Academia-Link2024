...
class EditarAnunciosWidget extends StatefulWidget {
  const EditarAnunciosWidget({
    super.key,
    required this.anuncioEditar,
  });

  final DocumentReference? anuncioEditar;
...
class _EditarAnunciosWidgetState extends State<EditarAnunciosWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<AnunciosRecord>(
      stream: AnunciosRecord.getDocument(widget.anuncioEditar!),
      builder: (context, snapshot) {
        ...
        final editarAnunciosAnunciosRecord = snapshot.data!;
                          ...
                          child: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.txtEditarTituloController ??=
                                          TextEditingController(
                                    text: editarAnunciosAnunciosRecord.titulo,
                                  ),
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.txtEditarAnuncioController ??=
                                              TextEditingController(
                                        text: editarAnunciosAnunciosRecord
                                            .descripcion,
                                      ),
                                      focusNode:
                                          _model.txtEditarAnuncioFocusNode,
                                      obscureText: false,
                                      decoration: InputDecoration(
