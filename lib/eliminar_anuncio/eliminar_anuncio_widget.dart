...
class EliminarAnuncioWidget extends StatefulWidget {
  const EliminarAnuncioWidget({super.key});

  @override
  State<EliminarAnuncioWidget> createState() => _EliminarAnuncioWidgetState();
}

class _EliminarAnuncioWidgetState extends State<EliminarAnuncioWidget> {
  late EliminarAnuncioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EliminarAnuncioModel());
